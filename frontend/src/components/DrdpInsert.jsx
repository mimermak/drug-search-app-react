...
// Component για εισαγωγή νέου record στον πίνακα DRDP
function DrdpInsert({ token }) {
  // State για τη φόρμα δεδομένων με αρχικές τιμές για κάθε πεδίο του DRDP
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Κλήση του POST /api/drdp για εισαγωγή δεδομένων
      await api.post('/drdp', formData);
  ...
  return (
    ...
    <Box sx={{ p: 2, maxWidth: 600, mx: 'auto' }}>
      {/* Τίτλος της σελίδας */}
      <Typography variant="h4" gutterBottom>Εισαγωγή DRDP</Typography>
